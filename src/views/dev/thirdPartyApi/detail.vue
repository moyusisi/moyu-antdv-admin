      ...
      <a-form ref="formRef" :model="formData" :label-col="{span: 6}">
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="8">
              <a-form-item name="code" label="唯一标识" tooltip="">
                <a-tag :bordered="false">{{ formData.code }}</a-tag>
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item name="thirdAppName" label="三方系统名称" tooltip="">
                <span>{{ formData.thirdAppName }}</span>
              </a-form-item>
            </a-col>
            <a-col :span="8">
        ...
        <a-card>
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item name="requestHeader" label="请求头参数" tooltip="" :label-col="{span: 2}" >
                <highlightjs v-if="formData.requestHeader" autodetect :code="formData.requestHeader" />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item name="requestBody" label="请求体参数" tooltip="" :label-col="{span: 2}" >
                <highlightjs v-if="formData.requestBody" autodetect :code="formData.requestBody" />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item name="responseBody" label="响应结果" tooltip="" :label-col="{span: 2}" >
